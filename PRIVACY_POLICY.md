...
We collect limited information necessary to provide the game experience, save your progress, and maintain the global leaderboard.

### A. Information You Provide to Us
* **Account Information:** When you sign up, we collect your **Email Address** and a **Username** (or "Display Name").
...
We use trusted third-party services to handle data storage and authentication. These partners may process data on our behalf:
...
In compliance with Facebook and Apple platform rules, we provide two simple ways to delete your data:

**Option 1: Instant In-App Deletion (Recommended)**
1.  Open **The President** app.
2.  Navigate to the **Profile** screen (tap the person icon on the Home screen).
3.  Scroll to the bottom and tap the red **"Delete Account"** button.
4.  **Result:** This action immediately and permanently deletes your authentication record, your profile, and your high scores from our database.

**Option 2: Email Request**
If you cannot access the app, you may request data deletion by emailing us at:
* **Email:** prince.goel.in@gmail.com
